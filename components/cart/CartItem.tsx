...
export function CartItem({ item, className, showRemoveButton = true, compact = false }: CartItemProps) {
  ...
  const displayImage = variantImage || primaryImage?.url || '/placeholder-image.jpg'
        ...
        <div className="flex items-center justify-between mt-2">
          ...
          <div className="flex items-center space-x-2">
            <div className="flex items-center border border-gray-300 rounded-md">
              ...
              <span className={cn(
                "min-w-[2rem] text-center px-2 font-medium",
                compact ? "text-xs" : "text-sm"
              )}>
                {item.quantity}
              </span>
