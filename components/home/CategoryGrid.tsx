  ...
  return (
    <section className="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {categories.map((category) => (
          <Link
            key={category.id}
            href={category.href}
            className="group relative overflow-hidden rounded-lg bg-gray-100 aspect-square card-hover"
          >
            <Image
              src={category.image}
              alt={category.name}
      ...
      <div className="text-center mt-12">
        ...
        <Link
          href="/all-products"
          className="inline-flex items-center text-textile-navy hover:text-textile-terracotta font-medium transition-colors duration-200"
        >
          View All Products
